...
parser.add_argument("--onnx", action='store_true', help="[Beta] Use diffusers' OnnxStableDiffusionPipeline instead of LDM.", default=False)
parser.add_argument("--olive", action='store_true', help="[Beta] Enable Olive optimization support. Implicitly includes --onnx argument.", default=False)
